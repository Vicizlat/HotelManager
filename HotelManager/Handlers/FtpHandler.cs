...
namespace HotelManager
{
    ...
    {
        public static bool TryGetRemoteFileTime(out DateTime? remoteFileLastWrite)
        {
            try
            {
                ...
                Logging.Instance.WriteLine($"Remote file time: {remoteFileLastWrite:dd.MM.yyyy HH:mm:ss}");
                return true;
            }
            catch
            {
